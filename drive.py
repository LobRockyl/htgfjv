...
class MSPio:
	...
	def arm(self):
		...
		* **** WARNING! ****
		...
		ROLL, PITCH, YAW, THROTTLE, AUX1, AUX2, AUX3, AUX4= 1500, 1500, 1500, 1000, 1400, 1000, 0, 0
...
if __name__ == '__main__':
	...
	if ser.is_open():
		...
		ser.set_raw_rc([1500, 1500, 1500, 1000, 1460, 1000, 1000, 1000])
		...
		while time.time() - start < 2:
			...
			ser.set_raw_rc([1500, 1500, 1500, 1000, 1000, 1000, 1000, 1000])
		...
		while time.time() - start <5:
			...
			ser.set_raw_rc([1500, 1500, 1500, 1000, 1400, 1000, 1000, 1000])
      print(ser.read_response(ser.MSP_RC, ser.RC_PARSE))
